 ...
 * @author admin01
 */
public class ViewDeclineRequestsJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ViewDeclineRequestsJPanel
     */
    ...
    ViewDeclineRequestsJPanel(JPanel userProcessContainer, Useraccount userAccount, CustomerServiceDepartment department, Enterprise enterprise) {
        initComponents();
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : department.getWorkQueue().getWorkRequestList()){
            if (request instanceof CustomerAccountWorkRequest  && request.getStatus().equalsIgnoreCase("Declined"))
            {
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer SSN", "Receiver", "Status", "Request Date", "Resolve Date", "Account no", "Routing No"
            }
        ));
